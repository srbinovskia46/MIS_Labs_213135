...
import 'package:lab3/screens/map_page.dart';
import 'package:lab3/service/notification_service.dart';
import 'package:lab3/utils/notification_controller.dart';
...
class _CalendarExamsState extends State<CalendarExams> {
  ...
  void initState() {
    ...
    loadExamData();
    NotificationService();
    NotificationService().scheduleNotificationsForExams(exams);
  }
